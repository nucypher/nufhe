...
from .polynomials import TorusPolynomialArray, IntPolynomialArray, TransformedPolynomialArray
...
class TLweKey:
    ...
    def __init__(self, thr, rng, params: TLweParams):
        ...
        key = IntPolynomialArray(rand_uniform_int32(thr, rng, (k, N)))

        self.params = params
        self.key = key # `mask_size` binary polynomials
...
class TLweSampleArray:
    ...
    def __init__(self, thr, params: TLweParams, shape):
        ...
        self.a = TorusPolynomialArray.empty(thr, params.polynomial_degree, shape + (self.mask_size + 1,))
